...
const forms = {
  estadisticasGenerales: {
    ...
    structure: [
      {
        title:
          '01 EMISION DE ALERTAS TEMPRANAS EN APOYO A LA PNP , EN ACTIVIDADES PRESUNTAMENTE DELICTIVAS',
        items: [
          {
            subtitle:
          ...
          },
          {
            ...
            fields: [
              'PRESUNTO ROBO A PERSONAS (CELULARES, MOCHILAS, CARTERAS, BILLETERAS, RELOGES, JOYAS Y OTROS)',
          ...
          },
          {
            ...
            fields: [
              ...
              'PRESUNTO TRAFICO ILICITO DE DROGAS (PROMOCION, FAVORECIMIENTO, COMERCIALIZACION, PRODUCCION, MICROCOMERCIALIZACION Y POSESION).',
            ],
          },
          {
          ...
          },
          {
            ...
            fields: [
              ...
              'PRESUNTA ACTIVIDAD TERRORISTA (PROVOCA, CREA O MANTIENE ESTADO DE ZOZOBRA, ALARMA O TERROR A LA POBLACION)',
          ...
          },
          {
            ...
            fields: [
              ...
              'COMETIDOS POR PARTICULARES (USURPACION DE AUTORIDAD, VIOLENCIA Y RESISTENCIA, OTROS)',
            ],
          },
          {
      ...
      {
        title:
          '02 EMISION DE ALERTAS TEMPRANAS EN APOYO A LA PNP EN PRESUNTAS FALTAS',
        items: [
          {
          ...
          },
          {
            ...
            fields: [
              'HURTO SIMPLE COD. PENAL PERUANO ART. 444 CUANDO LA ACCION RECAE SOBRE UN BIEN CUYO VALOR NO SOBRE PASE EL 10 % DE LA UIT.',
      ...
      {
        title:
          '03 EMISION DE ALERTAS TEMPRANAS EN APOYO A LA PNP Y OTRAS GERENCIAS, EN PRESUNTAS INFRACCIONES',
        items: [
          {
            subtitle:
          ...
          },
          {
            ...
            fields: [
              'CAMBISTAS EN VÍA PÚBLICA (INTERRUMPEN TRÁNSITO PEATONAL Y VEHICULAR)',
              ...
              'PRESUNTOS TRABAJadores SEXUALES EN LA VIA PÚBLICA (MASCULINO O FEMENINO)',
              'PRESUNTAS PERSONAS QUE MICCIONAN EN VIA PÚBLICA',
              'OTROS PRESUNTOS (ESPECIFICAR EN EL ACAPITE DATOS IMPORTANTES DEL FORMATO DE OCURRENCIAS)',
            ],
          },
          {
            subtitle:
            ...
            fields: [
              ...
              'ESTABLECIMIENTOS EN MALAS CONDICIONES DE LIMPIEZA',
              'RUIDOS MOLESTOS',
              ...
              'OTROS (ESPECIFICAR EN EL ACAPITE DATOS IMPORTANTES DEL FORMATO DE OCURRENCIAS)',
            ],
          },
        ],
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            fields: [
              'FISCALIZACIÓN Y OTROS (ESPECIFICAR EN EL ACAPITE DATOS IMPORTANTES DEL FORMATO DE OCURRENCIAS)',
            ],
          },
          {
            subtitle: '0403 APOYO A OTRAS ENTIDADES',
            fields: [
              'POLICÍA NACIONAL Y OTROS (ESPECIFICAR EN EL ACAPITE DATOS IMPORTANTES DEL FORMATO DE OCURRENCIAS)',
            ],
          },
        ],
      },
      {
        title:
          '05 EMISION DE ALERTAS TEMPRANAS EN DESASTRES, INFRAESTRUCTURA, SERVICIOS Y ESPACIOS PÚBLICOS AFECTADOS Y EN RIESGO',
        items: [
          {
          ...
          },
          {
            ...
            fields: [
              ...
              'VIAS SEMI OBSTRUIDAS (POR BACHES PROFUNDOS O GRANCONGESTIÓN VEHICULAR)',
        ...
        items: [
          {
            ...
            fields: [
              'SUICIDIO',
              'INTENTO DE SUICIDIO',
              'MUERTE REPENTINA E/O NATURAL (ESPECIFICAR EN EL ACAPITE DATOS IMPORTANTES DEL FORMATO DE OCURRENCIAS)',
              'OTROS (ESPECIFICAR EN EL ACAPITE DATOS IMPORTANTES DEL FORMATO DE OCURRENCIAS)',
            ],
          },
        ],
        ...
        items: [
          {
            ...
            fields: [
              ...
              'OTROS OPERATIVOS MUNICIPALES (ESPECIFICAR EN LA SECCIÓN DATOS IMPORTANTES DEL FORMATO DE OCURRENCIAS)',
            ],
          },
          {
            subtitle: '0702 ESTRATEGIAS Y OPERATIVOS ESPECIALES',
            fields: [
              'EN APOYO A LA PNP EN PROGRAMAS PREVENTIVOS (ESPECIFICAR EN EL ACAPITE DATOS IMPORTANTES DEL FORMATO DE OCURRENCIAS)',
              'APOYO A OTRAS ENTIDADES EN PROGRAMAS PREVENTIVOS (ESPECIFICAR EN EL ACAPITE DATOS IMPORTANTES DEL FORMATO DE OCURRENCIAS)',
    ...
    structure: [
      ...
      },
      {
        ...
        items: [
          {
            subtitle: '',
            fields: ['0601 PRESUNTOS ACONTECIMIENTOS ESPECIALES'],
          },
        ],
      },
      {
  ...
  observatorioDelito: {
    ...
    structure: [
      ...
      'Ley de violencia contra la mujer y los integrantes del grupo familiar',
      'Omisión a la asistencia familiar',
      'Peligro común (delito)',
      'Patrimonio (delito)',
      'Seguridad pública (delito)',
      'Tranquilidad publica (delito)',
      'Vida, cuerpo y salud (delito)',
    ],
    render: renderSimpleForm,
  },
  operativosPatrullaje: {
    ...
    format: 'vertical',
    structure: [
      'Operativos Serenazgo',
      'Op. Escuadrón Verde',
      'Op. con Halcones',
      'Patrullaje Integrado',
      'Patrullaje por Convenio',
      'Brigada Canina',
    ],
    render: renderSimpleForm,
  },
...
function renderVehiculosForm(formDef, data) {
  ...
  const totalOperativas =
    (data[keys['Nro. Operativas']] || 0) +
    (data[keys['Nro. en Mantenimiento']] || 0) +
    (data[keys['Nro. Inoperativas']] || 0);
  html += `
...
function updateView() {
  ...
  monthSelect.style.display =
    isReportView || isUploadView || isExportView ? 'none' : 'block';
  ...
  viewTitle.textContent = activeLink
  ...
  state.unsubscribe = onSnapshot(
    ...
    (docSnap) => {
      if (docSnap.exists()) {
        ...
        console.log(
          `Document ${docId} does not exist. Creating new one locally.`
        );
        state.data = {};
      }
...
function handleInputChange(e) {
  if (e.target.matches('input[type="number"]')) {
    ...
    if (key) {
      ...
      updateSaveButton();
      if (
        key.startsWith('vehiculos_nro-operativas') ||
        key.startsWith('vehiculos_nro-en-mantenimiento') ||
        key.startsWith('vehiculos_nro-inoperativas')
      ) {
...
function updateVehiculosTotal() {
  const operativas =
    Number(document.getElementById('vehiculos_nro-operativas')?.value) || 0;
  const mantenimiento =
...
function calculateTotals() {
  ...
  for (const formKey in forms) {
    ...
    fields.forEach(({ title, field }) => {
      ...
      for (let month = 1; month <= 12; month++) {
        const value =
          (state.annualData[month] && state.annualData[month][key]) || 0;
...
function handleFileSelect(e) {
  ...
  if (file) {
    ...
    document.getElementById(`${forms[formKey].uploadId}-status`).textContent =
      file.name;
    document
      .getElementById(`${forms[formKey].uploadId}-status`)
...
async function handleBulkUpload() {
  ...
  const uploadBtn = document.getElementById('process-upload-btn');
  uploadBtn.disabled = true;
  uploadStatus.innerHTML = `<div class="flex items-center justify-center text-sky-600"><div class="animate-spin rounded-full h-5 w-5 border-t-2 border-b-2 border-sky-500 mr-3"></div>Procesando archivos...</div>`;

  const year = state.currentYear;
  const batch = writeBatch(db);
  let filesProcessed = 0;

  for (const formKey in state.filesToUpload) {
    const file = state.filesToUpload[formKey];
    const formDef = forms[formKey];
    ...
    try {
      ...
      results.data.forEach((row) => {
        ...
        if (month >= 1 && month <= 12) {
          ...
          batch.set(docRef, dataForMonth, { merge: true });
        }
      });
      filesProcessed++;
    } catch (error) {
      console.error(`Error processing file for ${formDef.title}:`, error);
      uploadStatus.innerHTML = `<p class="text-red-500">Error al procesar el archivo para ${formDef.title}.</p>`;
  ...
  if (filesProcessed > 0) {
    try {
      await batch.commit();
      uploadStatus.innerHTML = `<p class="text-green-600">¡${filesProcessed} archivo(s) procesado(s) y guardado(s) con éxito!</p>`;
    } catch (error) {
      console.error('Error committing batch:', error);
      uploadStatus.innerHTML = `<p class="text-red-500">Error al guardar los datos en la base de datos.</p>`;
    }
  } else {
    uploadStatus.innerHTML = `<p class="text-yellow-600">No se seleccionaron archivos válidos para procesar.</p>`;
  }
...
async function handleExport() {
  ...
  if (formDef.format === 'vertical') {
    ...
    if (categoryKey === 'all') {
      ...
      const fieldName = formDef.structure.find(
        (f) => `${toSlug(formDef.title)}_${toSlug(f)}` === categoryKey
      );
    ...
    if (categoryKey === 'all') {
      ...
      const { fieldName } = findFieldNameAndSectionByKey(formDef, categoryKey);
      if (fieldName) {
...
function initApp() {
  ...
  document
    .getElementById('chart-category-select')
